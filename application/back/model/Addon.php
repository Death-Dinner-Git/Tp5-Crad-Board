...
class Addon extends Model
{
    ...
    protected $_validate = array(
        array('name', 'require', '插件名称不能为空', 'regex',),
        array('name', '1,32', '插件名称长度为1-32个字符', 'length', ),
        array('name', '', '插件名称已经存在', 'unique'),
        array('description', 'require', '钩子描述必须！',  'regex',),
    );
