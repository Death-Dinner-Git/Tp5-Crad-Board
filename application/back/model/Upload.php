...
class Upload extends Model
{
    ...
    protected $_auto = array(
        array('uid', 'isGuest', self::MODEL_INSERT, 'function'),
    ...
    public function crop($data = null)
    {
        ...
        $type = $image->type();
        if ($image) {
            $file = './Uploads/temp/' . \wf\Str::randString(12, 1) . '.' . $type;
    ...
    public function upload($files = null)
    {
        ...
        $upload                       = new \wf\Upload($upload_config, $upload_driver, C("UPLOAD_{$upload_driver}_CONFIG")); // 实例化上传类
