 ...
 */
use app\common\components\upload\driver\bcs\BCS_RequestCore_Exception as BCS_RequestCore_Exception;
...
class BcsRequestcore
{
    ...
    public function processResponse($curl_handle = null, $response = null)
    {
        ...
        if (is_resource($this->curl_handle)) {
            ...
            if ($curl_handle && $response) {
                $class = '\app\common\components\upload\driver\bcs\\' . $this->response_class;
