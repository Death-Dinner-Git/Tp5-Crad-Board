...
class Upload
{
    ...
    public function upload($files = '')
    {
        ...
        foreach ($files as $key => $file) {
            ...
            if (in_array($ext, array('gif', 'jpg', 'jpeg', 'bmp', 'png', 'sapp\common\components'))) {
    ...
    private function setDriver($driver = null, $config = null)
    {
        ...
        $class          = strpos($driver, '\\') ? $driver : 'app\common\components\\upload\\driver\\' . ucfirst(strtolower($driver));
